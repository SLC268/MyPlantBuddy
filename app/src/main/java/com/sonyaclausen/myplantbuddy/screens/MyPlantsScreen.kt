...
@Composable
fun MyPlantsScreen(onBackPress: () -> Unit, modifier: Modifier) {
    ScreenContent(onBackPress)
}

@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun ScreenContent(onBackPress: () -> Unit) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
...
private fun MyPlantsGrid(
    ...
    LazyVerticalGrid(
        ...
        items(20) {
            GridCard(image = image, title = "Rubber Plant") {
